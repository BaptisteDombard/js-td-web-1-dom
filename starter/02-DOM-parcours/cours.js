...
*/
for (let i=0;i<document.getElementsByClassName("merveilles").length;i++){
    console.log(document.getElementsByClassName("merveilles")[i]);
}
...
// Le contenu HTML de l'ul qui n'a pas la classe "merveilles"
// console.log(document.querySelector("ul").querySelector(""))
...
console.log(document.querySelector("#antiques").classList.contains("merveille"));
